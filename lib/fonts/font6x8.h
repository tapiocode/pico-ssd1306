...
#define FONT6X8_COUNT (sizeof(font6x8) / sizeof(font6x8[0]))

static const ssd1306_font_t font6x8_font = {
    .data = &font6x8[0][0],
    .width = FONT6X8_COLS,
    .height = FONT6X8_ROWS,
    .first = FONT6X8_FIRST,
    .count = (uint8_t)FONT6X8_COUNT,
};
